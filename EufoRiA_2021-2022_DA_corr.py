...
KF_option = 1             # 1: Kalman filter On,                                     # 0: Kalman filter OFF (No data assimilation)
spatial_corr_on = 1       # 1: spatial correlation in the process noise cov matrix,  # other numbers: no correlation
saved_spatial_corr = 1    # 1: read from the pre_calculated correlation data,        # 0: re-calculate them
...
scenario_list = ['S01_DA','S02_DA','S03_DA','S04_DA','S05_DA', 'S06_DA', 'S07_DA']

for sc_nm in scenario_list:
    scenario_path = f'{input_path}/Corr_data/{sc_nm}'
